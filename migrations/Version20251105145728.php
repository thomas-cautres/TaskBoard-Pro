...
final class Version20251105145728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD CONSTRAINT FK_527EDB25AFB2CB02 FOREIGN KEY (project_column_id) REFERENCES project_column (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP CONSTRAINT FK_527EDB25AFB2CB02');
